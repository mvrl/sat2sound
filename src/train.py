...
if __name__ == '__main__':
    ...
    if args.mode == 'dev': 
        ...
        trainer = pl.Trainer(profiler="simple",precision=32,fast_dev_run=6, max_epochs=4, logger=wb_logger, strategy=args.strategy, num_sanity_val_steps=4,
        ...
        accelerator=args.accelerator, devices=args.devices, callbacks=[ckpt_monitor1, ckpt_monitor2, ckpt_monitor3, lr_logger], 
